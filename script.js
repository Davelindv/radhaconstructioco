...
function showWelcomeMessage() {
    const welcomeMessage = `
        Welcome to Radha Construction Co.! How can I assist you today? 
        Feel free to ask any questions.
        Contact us at: 
        Phone: +968-7744 3018
        Email: info@radhaconstructionco.com
    `;
...
function showPopup(message) {
    document.getElementById('popup-text').innerText = message; // Set the popup text
